...
type
  ...
  public
    ...
    WorkPID: DWORD;
    WorkWND: HWND;
     {значения важные для работы бота}
    CurHP, {текущее хп}
    ...
    TargetHP {хп цели} :integer;

    IsTarget: boolean;
  end;

  {TCurСP - текущее СП персонажа}
  ...
  {TMaxСP - Максимальное СП персонажа}
  ...
  {TMaxHP - Максимальное ХП персонажа}
...
var
  ...
  BaseAddress:Cardinal;
  PID, PIDs,
  WorkPID{Выбранный PID пользователем}:DWORD;
  wnd, WorkWND,{WORK - с каким работает бот по PID}
  HandleWindow :HWND;
  HandleW: THandle;
...
begin
  ...
  with TInifile.Create(SaveDialog1.FileName) Do
    begin
      WriteBool('Умения','Умение 1 ВКЛ', Skill1IsUse.Checked);
      WriteBool('Умения','Умение 1 ДОБИВАНИЕ', Skill1IsUseLast.Checked);
      WriteInteger('Умения','Умение 1 КНОПКА', Skill1KeyEdit.HotKey);
      WriteString('Умения','Умение 1 ОТКАТ', Skill1CDEdit.Text);
      WriteBool('Умения','Умение 1 ЕСЛИ', Skill1IF.Checked);
      WriteString('Умения','Умение 1 ЕСЛИ ХП', Skill1IFHPEdit.Text);
      WriteString('Умения','Умение 1 ЕСЛИ МП', Skill1IFMPEdit.Text);
      WriteBool('Умения','Умение 1 ЕСЛИ ХП Б', Skill1IFHPMore.Checked);
      WriteBool('Умения','Умение 1 ЕСЛИ ХП М', Skill1IFHPLow.Checked);
      WriteBool('Умения','Умение 1 ЕСЛИ МП Б', Skill1IFMPMore.Checked);
      WriteBool('Умения','Умение 1 ЕСЛИ МП М', Skill1IFMPLow.Checked);

      WriteBool('Умения','Умение 2 ВКЛ', Skill2IsUse.Checked);
      WriteBool('Умения','Умение 2 ДОБИВАНИЕ', Skill2IsUseLast.Checked);
      WriteInteger('Умения','Умение 2 КНОПКА', Skill2KeyEdit.HotKey);
      WriteString('Умения','Умение 2 ОТКАТ', Skill2CDEdit.Text);
      WriteBool('Умения','Умение 2 ЕСЛИ', Skill2IF.Checked);
      WriteString('Умения','Умение 2 ЕСЛИ ХП', Skill2IFHPEdit.Text);
      WriteString('Умения','Умение 2 ЕСЛИ МП', Skill2IFMPEdit.Text);
      WriteBool('Умения','Умение 2 ЕСЛИ ХП Б', Skill2IFHPMore.Checked);
      WriteBool('Умения','Умение 2 ЕСЛИ ХП М', Skill2IFHPLow.Checked);
      WriteBool('Умения','Умение 2 ЕСЛИ МП Б', Skill2IFMPMore.Checked);
      WriteBool('Умения','Умение 2 ЕСЛИ МП М', Skill2IFMPLow.Checked);

      WriteBool('Умения','Умение 3 ВКЛ', Skill3IsUse.Checked);
      WriteBool('Умения','Умение 3 ДОБИВАНИЕ', Skill3IsUseLast.Checked);
      WriteInteger('Умения','Умение 3 КНОПКА', Skill3KeyEdit.HotKey);
      WriteString('Умения','Умение 3 ОТКАТ', Skill3CDEdit.Text);
      WriteBool('Умения','Умение 3 ЕСЛИ', Skill3IF.Checked);
      WriteString('Умения','Умение 3 ЕСЛИ ХП', Skill3IFHPEdit.Text);
      WriteString('Умения','Умение 3 ЕСЛИ МП', Skill3IFMPEdit.Text);
      WriteBool('Умения','Умение 3 ЕСЛИ ХП Б', Skill3IFHPMore.Checked);
      WriteBool('Умения','Умение 3 ЕСЛИ ХП М', Skill3IFHPLow.Checked);
      WriteBool('Умения','Умение 3 ЕСЛИ МП Б', Skill3IFMPMore.Checked);
      WriteBool('Умения','Умение 3 ЕСЛИ МП М', Skill3IFMPLow.Checked);

      WriteBool('Умения','Умение 4 ВКЛ', Skill4IsUse.Checked);
      WriteBool('Умения','Умение 4 ДОБИВАНИЕ', Skill4IsUseLast.Checked);
      WriteInteger('Умения','Умение 4 КНОПКА', Skill4KeyEdit.HotKey);
      WriteString('Умения','Умение 4 ОТКАТ', Skill4CDEdit.Text);
      WriteBool('Умения','Умение 4 ЕСЛИ', Skill4IF.Checked);
      WriteString('Умения','Умение 4 ЕСЛИ ХП', Skill4IFHPEdit.Text);
      WriteString('Умения','Умение 4 ЕСЛИ МП', Skill4IFMPEdit.Text);
      WriteBool('Умения','Умение 4 ЕСЛИ ХП Б', Skill4IFHPMore.Checked);
      WriteBool('Умения','Умение 4 ЕСЛИ ХП М', Skill4IFHPLow.Checked);
      WriteBool('Умения','Умение 4 ЕСЛИ МП Б', Skill4IFMPMore.Checked);
      WriteBool('Умения','Умение 4 ЕСЛИ МП М', Skill4IFMPLow.Checked);

      WriteBool('Умения','Умение 5 ВКЛ', Skill5IsUse.Checked);
      WriteBool('Умения','Умение 5 ДОБИВАНИЕ', Skill5IsUseLast.Checked);
      WriteInteger('Умения','Умение 5 КНОПКА', Skill5KeyEdit.HotKey);
      WriteString('Умения','Умение 5 ОТКАТ', Skill5CDEdit.Text);
      WriteBool('Умения','Умение 5 ЕСЛИ', Skill5IF.Checked);
      WriteString('Умения','Умение 5 ЕСЛИ ХП', Skill5IFHPEdit.Text);
      WriteString('Умения','Умение 5 ЕСЛИ МП', Skill5IFMPEdit.Text);
      WriteBool('Умения','Умение 5 ЕСЛИ ХП Б', Skill5IFHPMore.Checked);
      WriteBool('Умения','Умение 5 ЕСЛИ ХП М', Skill5IFHPLow.Checked);
      WriteBool('Умения','Умение 5 ЕСЛИ МП Б', Skill5IFMPMore.Checked);
      WriteBool('Умения','Умение 5 ЕСЛИ МП М', Skill5IFMPLow.Checked);

      WriteBool('Умения','Умение 6 ВКЛ', Skill6IsUse.Checked);
      WriteBool('Умения','Умение 6 ДОБИВАНИЕ', Skill6IsUseLast.Checked);
      WriteInteger('Умения','Умение 6 КНОПКА', Skill6KeyEdit.HotKey);
      WriteString('Умения','Умение 6 ОТКАТ', Skill6CDEdit.Text);
      WriteBool('Умения','Умение 6 ЕСЛИ', Skill6IF.Checked);
      WriteString('Умения','Умение 6 ЕСЛИ ХП', Skill6IFHPEdit.Text);
      WriteString('Умения','Умение 6 ЕСЛИ МП', Skill6IFMPEdit.Text);
      WriteBool('Умения','Умение 6 ЕСЛИ ХП Б', Skill6IFHPMore.Checked);
      WriteBool('Умения','Умение 6 ЕСЛИ ХП М', Skill6IFHPLow.Checked);
      WriteBool('Умения','Умение 6 ЕСЛИ МП Б', Skill6IFMPMore.Checked);
      WriteBool('Умения','Умение 6 ЕСЛИ МП М', Skill6IFMPLow.Checked);

      WriteBool('Умения','Умение 7 ВКЛ', Skill7IsUse.Checked);
      WriteBool('Умения','Умение 7 ДОБИВАНИЕ', Skill7IsUseLast.Checked);
      WriteInteger('Умения','Умение 7 КНОПКА', Skill7KeyEdit.HotKey);
      WriteString('Умения','Умение 7 ОТКАТ', Skill7CDEdit.Text);
      WriteBool('Умения','Умение 7 ЕСЛИ', Skill7IF.Checked);
      WriteString('Умения','Умение 7 ЕСЛИ ХП', Skill7IFHPEdit.Text);
      WriteString('Умения','Умение 7 ЕСЛИ МП', Skill7IFMPEdit.Text);
      WriteBool('Умения','Умение 7 ЕСЛИ ХП Б', Skill7IFHPMore.Checked);
      WriteBool('Умения','Умение 7 ЕСЛИ ХП М', Skill7IFHPLow.Checked);
      WriteBool('Умения','Умение 7 ЕСЛИ МП Б', Skill7IFMPMore.Checked);
      WriteBool('Умения','Умение 7 ЕСЛИ МП М', Skill7IFMPLow.Checked);

      WriteBool('Умения','Умение 8 ВКЛ', Skill8IsUse.Checked);
      WriteBool('Умения','Умение 8 ДОБИВАНИЕ', Skill8IsUseLast.Checked);
      WriteInteger('Умения','Умение 8 КНОПКА', Skill8KeyEdit.HotKey);
      WriteString('Умения','Умение 8 ОТКАТ', Skill8CDEdit.Text);
      WriteBool('Умения','Умение 8 ЕСЛИ', Skill8IF.Checked);
      WriteString('Умения','Умение 8 ЕСЛИ ХП', Skill8IFHPEdit.Text);
      WriteString('Умения','Умение 8 ЕСЛИ МП', Skill8IFMPEdit.Text);
      WriteBool('Умения','Умение 8 ЕСЛИ ХП Б', Skill8IFHPMore.Checked);
      WriteBool('Умения','Умение 8 ЕСЛИ ХП М', Skill8IFHPLow.Checked);
      WriteBool('Умения','Умение 8 ЕСЛИ МП Б', Skill8IFMPMore.Checked);
      WriteBool('Умения','Умение 8 ЕСЛИ МП М', Skill8IFMPLow.Checked);

      WriteBool('Умения','Умение 9 ВКЛ', Skill9IsUse.Checked);
      WriteBool('Умения','Умение 9 ДОБИВАНИЕ', Skill9IsUseLast.Checked);
      WriteInteger('Умения','Умение 9 КНОПКА', Skill9KeyEdit.HotKey);
      WriteString('Умения','Умение 9 ОТКАТ', Skill9CDEdit.Text);
      WriteBool('Умения','Умение 9 ЕСЛИ', Skill9IF.Checked);
      WriteString('Умения','Умение 9 ЕСЛИ ХП', Skill9IFHPEdit.Text);
      WriteString('Умения','Умение 9 ЕСЛИ МП', Skill9IFMPEdit.Text);
      WriteBool('Умения','Умение 9 ЕСЛИ ХП Б', Skill9IFHPMore.Checked);
      WriteBool('Умения','Умение 9 ЕСЛИ ХП М', Skill9IFHPLow.Checked);
      WriteBool('Умения','Умение 9 ЕСЛИ МП Б', Skill9IFMPMore.Checked);
      WriteBool('Умения','Умение 9 ЕСЛИ МП М', Skill9IFMPLow.Checked);

      WriteBool('Умения','Умение 10 ВКЛ', Skill10IsUse.Checked);
      WriteBool('Умения','Умение 10 ДОБИВАНИЕ', Skill10IsUseLast.Checked);
      WriteInteger('Умения','Умение 10 КНОПКА', Skill10KeyEdit.HotKey);
      WriteString('Умения','Умение 10 ОТКАТ', Skill10CDEdit.Text);
      WriteBool('Умения','Умение 10 ЕСЛИ', Skill10IF.Checked);
      WriteString('Умения','Умение 10 ЕСЛИ ХП', Skill10IFHPEdit.Text);
      WriteString('Умения','Умение 10 ЕСЛИ МП', Skill10IFMPEdit.Text);
      WriteBool('Умения','Умение 10 ЕСЛИ ХП Б', Skill10IFHPMore.Checked);
      WriteBool('Умения','Умение 10 ЕСЛИ ХП М', Skill10IFHPLow.Checked);
      WriteBool('Умения','Умение 10 ЕСЛИ МП Б', Skill10IFMPMore.Checked);
      WriteBool('Умения','Умение 10 ЕСЛИ МП М', Skill10IFMPLow.Checked);

      WriteBool('Умения','Умение 11 ВКЛ', Skill11IsUse.Checked);
      WriteBool('Умения','Умение 11 ДОБИВАНИЕ', Skill11IsUseLast.Checked);
      WriteInteger('Умения','Умение 11 КНОПКА', Skill11KeyEdit.HotKey);
      WriteString('Умения','Умение 11 ОТКАТ', Skill11CDEdit.Text);
      WriteBool('Умения','Умение 11 ЕСЛИ', Skill11IF.Checked);
      WriteString('Умения','Умение 11 ЕСЛИ ХП', Skill11IFHPEdit.Text);
      WriteString('Умения','Умение 11 ЕСЛИ МП', Skill11IFMPEdit.Text);
      WriteBool('Умения','Умение 11 ЕСЛИ ХП Б', Skill11IFHPMore.Checked);
      WriteBool('Умения','Умение 11 ЕСЛИ ХП М', Skill11IFHPLow.Checked);
      WriteBool('Умения','Умение 11 ЕСЛИ МП Б', Skill11IFMPMore.Checked);
      WriteBool('Умения','Умение 11 ЕСЛИ МП М', Skill11IFMPLow.Checked);

      WriteBool('Умения','Умение 12 ВКЛ', Skill12IsUse.Checked);
      WriteBool('Умения','Умение 12 ДОБИВАНИЕ', Skill12IsUseLast.Checked);
      WriteInteger('Умения','Умение 12 КНОПКА', Skill12KeyEdit.HotKey);
      WriteString('Умения','Умение 12 ОТКАТ', Skill12CDEdit.Text);
      WriteBool('Умения','Умение 12 ЕСЛИ', Skill12IF.Checked);
      WriteString('Умения','Умение 12 ЕСЛИ ХП', Skill12IFHPEdit.Text);
      WriteString('Умения','Умение 12 ЕСЛИ МП', Skill12IFMPEdit.Text);
      WriteBool('Умения','Умение 12 ЕСЛИ ХП Б', Skill12IFHPMore.Checked);
      WriteBool('Умения','Умение 12 ЕСЛИ ХП М', Skill12IFHPLow.Checked);
      WriteBool('Умения','Умение 12 ЕСЛИ МП Б', Skill12IFMPMore.Checked);
      WriteBool('Умения','Умение 12 ЕСЛИ МП М', Skill12IFMPLow.Checked);

      if RebuffClicksX.Count>0 then
      begin
        WriteString('Ребафф','Количество кликов', inttostr(RebuffClicksX.Count));
        for RebuffClicks:=0 to RebuffClicksX.Count-1 do
          begin
            WriteString('Ребафф','Координата X['+inttostr(RebuffClicks)+']', RebuffClicksX.Items.Strings[RebuffClicks]);
            WriteString('Ребафф','Координата Y['+inttostr(RebuffClicks)+']', RebuffClicksY.Items.Strings[RebuffClicks]);
        end;
       end;
    end;
end;
...
begin
  ...
  with TInifile.Create(OpenDialog1.FileName) Do
    begin
      Skill1IsUse.Checked:=ReadBool('Умения','Умение 1 ВКЛ',Skill1IsUse.Checked);
      Skill1IsUseLast.Checked:=ReadBool('Умения','Умение 1 ДОБИВАНИЕ',Skill1IsUseLast.Checked);
      Skill1KeyEdit.HotKey:=ReadInteger('Умения','Умение 1 КНОПКА', Skill1KeyEdit.HotKey);
      Skill1CDEdit.Text:=ReadString('Умения','Умение 1 ОТКАТ', Skill1CDEdit.Text);
      Skill1IF.Checked:=ReadBool('Умения','Умение 1 ЕСЛИ',Skill1IF.Checked);
      Skill1IFHPEdit.Text:=ReadString('Умения','Умение 1 ЕСЛИ ХП', Skill1IFHPEdit.Text);
      Skill1IFMPEdit.Text:=ReadString('Умения','Умение 1 ЕСЛИ МП', Skill1IFMPEdit.Text);
      Skill1CDEdit.Text:=ReadString('Умения','Умение 1 ОТКАТ', Skill1CDEdit.Text);
      Skill1IFHPMore.Checked:=ReadBool('Умения','Умение 1 ЕСЛИ ХП Б',Skill1IFHPMore.Checked);
      Skill1IFHPLow.Checked:=ReadBool('Умения','Умение 1 ЕСЛИ ХП М',Skill1IFHPLow.Checked);
      Skill1IFMPMore.Checked:=ReadBool('Умения','Умение 1 ЕСЛИ МП Б',Skill1IFMPMore.Checked);
      Skill1IFMPLow.Checked:=ReadBool('Умения','Умение 1 ЕСЛИ МП М',Skill1IFMPLow.Checked);

      Skill2IsUse.Checked:=ReadBool('Умения','Умение 2 ВКЛ',Skill2IsUse.Checked);
      Skill2IsUseLast.Checked:=ReadBool('Умения','Умение 2 ДОБИВАНИЕ',Skill2IsUseLast.Checked);
      Skill2KeyEdit.HotKey:=ReadInteger('Умения','Умение 2 КНОПКА', Skill2KeyEdit.HotKey);
      Skill2CDEdit.Text:=ReadString('Умения','Умение 2 ОТКАТ', Skill2CDEdit.Text);
      Skill2IF.Checked:=ReadBool('Умения','Умение 2 ЕСЛИ',Skill2IF.Checked);
      Skill2IFHPEdit.Text:=ReadString('Умения','Умение 2 ЕСЛИ ХП', Skill2IFHPEdit.Text);
      Skill2IFMPEdit.Text:=ReadString('Умения','Умение 2 ЕСЛИ МП', Skill2IFMPEdit.Text);
      Skill2CDEdit.Text:=ReadString('Умения','Умение 2 ОТКАТ', Skill2CDEdit.Text);
      Skill2IFHPMore.Checked:=ReadBool('Умения','Умение 2 ЕСЛИ ХП Б',Skill2IFHPMore.Checked);
      Skill2IFHPLow.Checked:=ReadBool('Умения','Умение 2 ЕСЛИ ХП М',Skill2IFHPLow.Checked);
      Skill2IFMPMore.Checked:=ReadBool('Умения','Умение 2 ЕСЛИ МП Б',Skill2IFMPMore.Checked);
      Skill2IFMPLow.Checked:=ReadBool('Умения','Умение 2 ЕСЛИ МП М',Skill2IFMPLow.Checked);

      Skill3IsUse.Checked:=ReadBool('Умения','Умение 3 ВКЛ',Skill3IsUse.Checked);
      Skill3IsUseLast.Checked:=ReadBool('Умения','Умение 3 ДОБИВАНИЕ',Skill3IsUseLast.Checked);
      Skill3KeyEdit.HotKey:=ReadInteger('Умения','Умение 3 КНОПКА', Skill3KeyEdit.HotKey);
      Skill3CDEdit.Text:=ReadString('Умения','Умение 3 ОТКАТ', Skill3CDEdit.Text);
      Skill3IF.Checked:=ReadBool('Умения','Умение 3 ЕСЛИ',Skill3IF.Checked);
      Skill3IFHPEdit.Text:=ReadString('Умения','Умение 3 ЕСЛИ ХП', Skill3IFHPEdit.Text);
      Skill3IFMPEdit.Text:=ReadString('Умения','Умение 3 ЕСЛИ МП', Skill3IFMPEdit.Text);
      Skill3CDEdit.Text:=ReadString('Умения','Умение 3 ОТКАТ', Skill3CDEdit.Text);
      Skill3IFHPMore.Checked:=ReadBool('Умения','Умение 3 ЕСЛИ ХП Б',Skill3IFHPMore.Checked);
      Skill3IFHPLow.Checked:=ReadBool('Умения','Умение 3 ЕСЛИ ХП М',Skill3IFHPLow.Checked);
      Skill3IFMPMore.Checked:=ReadBool('Умения','Умение 3 ЕСЛИ МП Б',Skill3IFMPMore.Checked);
      Skill3IFMPLow.Checked:=ReadBool('Умения','Умение 3 ЕСЛИ МП М',Skill3IFMPLow.Checked);

      Skill4IsUse.Checked:=ReadBool('Умения','Умение 4 ВКЛ',Skill4IsUse.Checked);
      Skill4IsUseLast.Checked:=ReadBool('Умения','Умение 4 ДОБИВАНИЕ',Skill4IsUseLast.Checked);
      Skill4KeyEdit.HotKey:=ReadInteger('Умения','Умение 4 КНОПКА', Skill4KeyEdit.HotKey);
      Skill4CDEdit.Text:=ReadString('Умения','Умение 4 ОТКАТ', Skill4CDEdit.Text);
      Skill4IF.Checked:=ReadBool('Умения','Умение 4 ЕСЛИ',Skill4IF.Checked);
      Skill4IFHPEdit.Text:=ReadString('Умения','Умение 4 ЕСЛИ ХП', Skill4IFHPEdit.Text);
      Skill4IFMPEdit.Text:=ReadString('Умения','Умение 4 ЕСЛИ МП', Skill4IFMPEdit.Text);
      Skill4CDEdit.Text:=ReadString('Умения','Умение 4 ОТКАТ', Skill4CDEdit.Text);
      Skill4IFHPMore.Checked:=ReadBool('Умения','Умение 4 ЕСЛИ ХП Б',Skill4IFHPMore.Checked);
      Skill4IFHPLow.Checked:=ReadBool('Умения','Умение 4 ЕСЛИ ХП М',Skill4IFHPLow.Checked);
      Skill4IFMPMore.Checked:=ReadBool('Умения','Умение 4 ЕСЛИ МП Б',Skill4IFMPMore.Checked);
      Skill4IFMPLow.Checked:=ReadBool('Умения','Умение 4 ЕСЛИ МП М',Skill4IFMPLow.Checked);

      Skill5IsUse.Checked:=ReadBool('Умения','Умение 5 ВКЛ',Skill5IsUse.Checked);
      Skill5IsUseLast.Checked:=ReadBool('Умения','Умение 5 ДОБИВАНИЕ',Skill5IsUseLast.Checked);
      Skill5KeyEdit.HotKey:=ReadInteger('Умения','Умение 5 КНОПКА', Skill5KeyEdit.HotKey);
      Skill5CDEdit.Text:=ReadString('Умения','Умение 5 ОТКАТ', Skill5CDEdit.Text);
      Skill5IF.Checked:=ReadBool('Умения','Умение 5 ЕСЛИ',Skill5IF.Checked);
      Skill5IFHPEdit.Text:=ReadString('Умения','Умение 5 ЕСЛИ ХП', Skill5IFHPEdit.Text);
      Skill5IFMPEdit.Text:=ReadString('Умения','Умение 5 ЕСЛИ МП', Skill5IFMPEdit.Text);
      Skill5CDEdit.Text:=ReadString('Умения','Умение 5 ОТКАТ', Skill5CDEdit.Text);
      Skill5IFHPMore.Checked:=ReadBool('Умения','Умение 5 ЕСЛИ ХП Б',Skill5IFHPMore.Checked);
      Skill5IFHPLow.Checked:=ReadBool('Умения','Умение 5 ЕСЛИ ХП М',Skill5IFHPLow.Checked);
      Skill5IFMPMore.Checked:=ReadBool('Умения','Умение 5 ЕСЛИ МП Б',Skill5IFMPMore.Checked);
      Skill5IFMPLow.Checked:=ReadBool('Умения','Умение 5 ЕСЛИ МП М',Skill5IFMPLow.Checked);

      Skill6IsUse.Checked:=ReadBool('Умения','Умение 6 ВКЛ',Skill6IsUse.Checked);
      Skill6IsUseLast.Checked:=ReadBool('Умения','Умение 6 ДОБИВАНИЕ',Skill6IsUseLast.Checked);
      Skill6KeyEdit.HotKey:=ReadInteger('Умения','Умение 6 КНОПКА', Skill6KeyEdit.HotKey);
      Skill6CDEdit.Text:=ReadString('Умения','Умение 6 ОТКАТ', Skill6CDEdit.Text);
      Skill6IF.Checked:=ReadBool('Умения','Умение 6 ЕСЛИ',Skill6IF.Checked);
      Skill6IFHPEdit.Text:=ReadString('Умения','Умение 6 ЕСЛИ ХП', Skill6IFHPEdit.Text);
      Skill6IFMPEdit.Text:=ReadString('Умения','Умение 6 ЕСЛИ МП', Skill6IFMPEdit.Text);
      Skill6CDEdit.Text:=ReadString('Умения','Умение 6 ОТКАТ', Skill6CDEdit.Text);
      Skill6IFHPMore.Checked:=ReadBool('Умения','Умение 6 ЕСЛИ ХП Б',Skill6IFHPMore.Checked);
      Skill6IFHPLow.Checked:=ReadBool('Умения','Умение 6 ЕСЛИ ХП М',Skill6IFHPLow.Checked);
      Skill6IFMPMore.Checked:=ReadBool('Умения','Умение 6 ЕСЛИ МП Б',Skill6IFMPMore.Checked);
      Skill6IFMPLow.Checked:=ReadBool('Умения','Умение 6 ЕСЛИ МП М',Skill6IFMPLow.Checked);

      Skill7IsUse.Checked:=ReadBool('Умения','Умение 7 ВКЛ',Skill7IsUse.Checked);
      Skill7IsUseLast.Checked:=ReadBool('Умения','Умение 7 ДОБИВАНИЕ',Skill7IsUseLast.Checked);
      Skill7KeyEdit.HotKey:=ReadInteger('Умения','Умение 7 КНОПКА', Skill7KeyEdit.HotKey);
      Skill7CDEdit.Text:=ReadString('Умения','Умение 7 ОТКАТ', Skill7CDEdit.Text);
      Skill7IF.Checked:=ReadBool('Умения','Умение 7 ЕСЛИ',Skill7IF.Checked);
      Skill7IFHPEdit.Text:=ReadString('Умения','Умение 7 ЕСЛИ ХП', Skill7IFHPEdit.Text);
      Skill7IFMPEdit.Text:=ReadString('Умения','Умение 7 ЕСЛИ МП', Skill7IFMPEdit.Text);
      Skill7CDEdit.Text:=ReadString('Умения','Умение 7 ОТКАТ', Skill7CDEdit.Text);
      Skill7IFHPMore.Checked:=ReadBool('Умения','Умение 7 ЕСЛИ ХП Б',Skill7IFHPMore.Checked);
      Skill7IFHPLow.Checked:=ReadBool('Умения','Умение 7 ЕСЛИ ХП М',Skill7IFHPLow.Checked);
      Skill7IFMPMore.Checked:=ReadBool('Умения','Умение 7 ЕСЛИ МП Б',Skill7IFMPMore.Checked);
      Skill7IFMPLow.Checked:=ReadBool('Умения','Умение 7 ЕСЛИ МП М',Skill7IFMPLow.Checked);

      Skill8IsUse.Checked:=ReadBool('Умения','Умение 8 ВКЛ',Skill8IsUse.Checked);
      Skill8IsUseLast.Checked:=ReadBool('Умения','Умение 8 ДОБИВАНИЕ',Skill8IsUseLast.Checked);
      Skill8KeyEdit.HotKey:=ReadInteger('Умения','Умение 8 КНОПКА', Skill8KeyEdit.HotKey);
      Skill8CDEdit.Text:=ReadString('Умения','Умение 8 ОТКАТ', Skill8CDEdit.Text);
      Skill8IF.Checked:=ReadBool('Умения','Умение 8 ЕСЛИ',Skill8IF.Checked);
      Skill8IFHPEdit.Text:=ReadString('Умения','Умение 8 ЕСЛИ ХП', Skill8IFHPEdit.Text);
      Skill8IFMPEdit.Text:=ReadString('Умения','Умение 8 ЕСЛИ МП', Skill8IFMPEdit.Text);
      Skill8CDEdit.Text:=ReadString('Умения','Умение 8 ОТКАТ', Skill8CDEdit.Text);
      Skill8IFHPMore.Checked:=ReadBool('Умения','Умение 8 ЕСЛИ ХП Б',Skill8IFHPMore.Checked);
      Skill8IFHPLow.Checked:=ReadBool('Умения','Умение 8 ЕСЛИ ХП М',Skill8IFHPLow.Checked);
      Skill8IFMPMore.Checked:=ReadBool('Умения','Умение 8 ЕСЛИ МП Б',Skill8IFMPMore.Checked);
      Skill8IFMPLow.Checked:=ReadBool('Умения','Умение 8 ЕСЛИ МП М',Skill8IFMPLow.Checked);

      Skill9IsUse.Checked:=ReadBool('Умения','Умение 9 ВКЛ',Skill9IsUse.Checked);
      Skill9IsUseLast.Checked:=ReadBool('Умения','Умение 9 ДОБИВАНИЕ',Skill9IsUseLast.Checked);
      Skill9KeyEdit.HotKey:=ReadInteger('Умения','Умение 9 КНОПКА', Skill9KeyEdit.HotKey);
      Skill9CDEdit.Text:=ReadString('Умения','Умение 9 ОТКАТ', Skill9CDEdit.Text);
      Skill9IF.Checked:=ReadBool('Умения','Умение 9 ЕСЛИ',Skill9IF.Checked);
      Skill9IFHPEdit.Text:=ReadString('Умения','Умение 9 ЕСЛИ ХП', Skill9IFHPEdit.Text);
      Skill9IFMPEdit.Text:=ReadString('Умения','Умение 9 ЕСЛИ МП', Skill9IFMPEdit.Text);
      Skill9CDEdit.Text:=ReadString('Умения','Умение 9 ОТКАТ', Skill9CDEdit.Text);
      Skill9IFHPMore.Checked:=ReadBool('Умения','Умение 9 ЕСЛИ ХП Б',Skill9IFHPMore.Checked);
      Skill9IFHPLow.Checked:=ReadBool('Умения','Умение 9 ЕСЛИ ХП М',Skill9IFHPLow.Checked);
      Skill9IFMPMore.Checked:=ReadBool('Умения','Умение 9 ЕСЛИ МП Б',Skill9IFMPMore.Checked);
      Skill9IFMPLow.Checked:=ReadBool('Умения','Умение 9 ЕСЛИ МП М',Skill9IFMPLow.Checked);

      Skill10IsUse.Checked:=ReadBool('Умения','Умение 10 ВКЛ',Skill10IsUse.Checked);
      Skill10IsUseLast.Checked:=ReadBool('Умения','Умение 10 ДОБИВАНИЕ',Skill10IsUseLast.Checked);
      Skill10KeyEdit.HotKey:=ReadInteger('Умения','Умение 10 КНОПКА', Skill10KeyEdit.HotKey);
      Skill10CDEdit.Text:=ReadString('Умения','Умение 10 ОТКАТ', Skill10CDEdit.Text);
      Skill10IF.Checked:=ReadBool('Умения','Умение 10 ЕСЛИ',Skill10IF.Checked);
      Skill10IFHPEdit.Text:=ReadString('Умения','Умение 10 ЕСЛИ ХП', Skill10IFHPEdit.Text);
      Skill10IFMPEdit.Text:=ReadString('Умения','Умение 10 ЕСЛИ МП', Skill10IFMPEdit.Text);
      Skill10CDEdit.Text:=ReadString('Умения','Умение 10 ОТКАТ', Skill10CDEdit.Text);
      Skill10IFHPMore.Checked:=ReadBool('Умения','Умение 10 ЕСЛИ ХП Б',Skill10IFHPMore.Checked);
      Skill10IFHPLow.Checked:=ReadBool('Умения','Умение 10 ЕСЛИ ХП М',Skill10IFHPLow.Checked);
      Skill10IFMPMore.Checked:=ReadBool('Умения','Умение 10 ЕСЛИ МП Б',Skill10IFMPMore.Checked);
      Skill10IFMPLow.Checked:=ReadBool('Умения','Умение 10 ЕСЛИ МП М',Skill10IFMPLow.Checked);

      Skill11IsUse.Checked:=ReadBool('Умения','Умение 11 ВКЛ',Skill11IsUse.Checked);
      Skill11IsUseLast.Checked:=ReadBool('Умения','Умение 11 ДОБИВАНИЕ',Skill11IsUseLast.Checked);
      Skill11KeyEdit.HotKey:=ReadInteger('Умения','Умение 11 КНОПКА', Skill11KeyEdit.HotKey);
      Skill11CDEdit.Text:=ReadString('Умения','Умение 11 ОТКАТ', Skill11CDEdit.Text);
      Skill11IF.Checked:=ReadBool('Умения','Умение 11 ЕСЛИ',Skill11IF.Checked);
      Skill11IFHPEdit.Text:=ReadString('Умения','Умение 11 ЕСЛИ ХП', Skill11IFHPEdit.Text);
      Skill11IFMPEdit.Text:=ReadString('Умения','Умение 11 ЕСЛИ МП', Skill11IFMPEdit.Text);
      Skill11CDEdit.Text:=ReadString('Умения','Умение 11 ОТКАТ', Skill11CDEdit.Text);
      Skill11IFHPMore.Checked:=ReadBool('Умения','Умение 11 ЕСЛИ ХП Б',Skill11IFHPMore.Checked);
      Skill11IFHPLow.Checked:=ReadBool('Умения','Умение 11 ЕСЛИ ХП М',Skill11IFHPLow.Checked);
      Skill11IFMPMore.Checked:=ReadBool('Умения','Умение 11 ЕСЛИ МП Б',Skill11IFMPMore.Checked);
      Skill11IFMPLow.Checked:=ReadBool('Умения','Умение 11 ЕСЛИ МП М',Skill11IFMPLow.Checked);

      Skill12IsUse.Checked:=ReadBool('Умения','Умение 12 ВКЛ',Skill12IsUse.Checked);
      Skill12IsUseLast.Checked:=ReadBool('Умения','Умение 1 ДОБИВАНИЕ',Skill12IsUseLast.Checked);
      Skill12KeyEdit.HotKey:=ReadInteger('Умения','Умение 12 КНОПКА', Skill12KeyEdit.HotKey);
      Skill12CDEdit.Text:=ReadString('Умения','Умение 12 ОТКАТ', Skill12CDEdit.Text);
      Skill12IF.Checked:=ReadBool('Умения','Умение 12 ЕСЛИ',Skill12IF.Checked);
      Skill12IFHPEdit.Text:=ReadString('Умения','Умение 12 ЕСЛИ ХП', Skill12IFHPEdit.Text);
      Skill12IFMPEdit.Text:=ReadString('Умения','Умение 12 ЕСЛИ МП', Skill12IFMPEdit.Text);
      Skill12CDEdit.Text:=ReadString('Умения','Умение 12 ОТКАТ', Skill12CDEdit.Text);
      Skill12IFHPMore.Checked:=ReadBool('Умения','Умение 12 ЕСЛИ ХП Б',Skill12IFHPMore.Checked);
      Skill12IFHPLow.Checked:=ReadBool('Умения','Умение 12 ЕСЛИ ХП М',Skill12IFHPLow.Checked);
      Skill12IFMPMore.Checked:=ReadBool('Умения','Умение 12 ЕСЛИ МП Б',Skill12IFMPMore.Checked);
      Skill12IFMPLow.Checked:=ReadBool('Умения','Умение 12 ЕСЛИ МП М',Skill12IFMPLow.Checked);

      RebuffClicks:=ReadInteger('Ребафф','Количество кликов', RebuffClicks);
      if RebuffClicks>0 then
      begin
        for i:=0 to RebuffClicks-1 do
          begin
            RebuffClicksX.Items.Add(ReadString('Ребафф','Координата X['+inttostr(i)+']', '0'));
            RebuffClicksY.Items.Add(ReadString('Ребафф','Координата Y['+inttostr(i)+']', '0'));
        end;
       end;
    end;
end;
...
begin
  ...
  h:=OpenProcess(PROCESS_ALL_ACCESS,False,TPID);   {получаем доступ к процессу}
      ReadProcessMemory(h, Pointer(address), @buf, SIZE_T(4), outbytes);  {читаем память}
      ReadProcessMemory(h, Pointer(buf+$3A4), @buf, SIZE_T(4), outbytes);  {читаем память}
      ReadProcessMemory(h, Pointer(buf+$BC), @buf, SIZE_T(4), outbytes);  {читаем память}
      ReadProcessMemory(h, Pointer(buf+$360), @buf, SIZE_T(4), outbytes);  {читаем память}
      ReadProcessMemory(h, Pointer(buf+$34), @buf, SIZE_T(4), outbytes);  {читаем память}
      ReadProcessMemory(h, Pointer(buf+$240), @buf, SIZE_T(4), outbytes);  {читаем память}
      TResult:=buf;
      synchronize(Result);
  closehandle(h);
  {предупреждение о разводе на ПВП}
  if BOT.InfoTipIsAttack.Checked=True then
  begin
    if TResult<BOT.MaxCP then
    begin
      BOT.TrayIcon1.BalloonTitle:='Развод на пвп';
      BOT.TrayIcon1.BalloonHint:='Бот получил повреждения не от монстров. Возможно его пытаются развести на ПВП.';
...
begin
  ...
  h:=OpenProcess(PROCESS_ALL_ACCESS,False,TPID);   {получаем доступ к процессу}
      ...
      ReadProcessMemory(h, Pointer(buf+$360), @buf, SIZE_T(4), outbytes);  {читаем память}
      ReadProcessMemory(h, Pointer(buf+$34), @buf, SIZE_T(4), outbytes);  {читаем память}
      ReadProcessMemory(h, Pointer(buf+$238), @buf, SIZE_T(4), outbytes);  {читаем память}
      TResult:=buf;
      synchronize(Result);
  closehandle(h);
end;
...
begin
  ...
  h:=OpenProcess(PROCESS_ALL_ACCESS,False,TPID);   {получаем доступ к процессу}
      ...
      ReadProcessMemory(h, Pointer(buf+$3A4), @buf, SIZE_T(4), outbytes);  {читаем память}
      ReadProcessMemory(h, Pointer(buf+$BC), @buf, SIZE_T(4), outbytes);  {читаем память}
      ReadProcessMemory(h, Pointer(buf+$364), @buf, SIZE_T(4), outbytes);  {читаем память}
      ReadProcessMemory(h, Pointer(buf+$34), @buf, SIZE_T(4), outbytes);  {читаем память}
      ReadProcessMemory(h, Pointer(buf+$240), @buf, SIZE_T(4), outbytes);  {читаем память}
      TResult:=buf;
      synchronize(Result);
  closehandle(h);
  if TResult=0 then BOT.ShutDown; {если хп 0, то запускаем процедуру}
  {предупреждение о малом запасе здоровья}
  if BOT.InfoTipIsLowHp.Checked=True then
  begin
    if TResult<1000 then
    begin
      BOT.TrayIcon1.BalloonTitle:='Малый запас здоровья';
      BOT.TrayIcon1.BalloonHint:='У вашего персонажа очень маленький запас здоровья.';
      BOT.TrayIcon1.ShowBalloonHint;
    end;
  end;
  {предупреждение о малом запасе здоровья}
  ...
  begin
    if TResult<=0 then
    begin
      BOT.TrayIcon1.BalloonTitle:='Персонаж умер';
      BOT.TrayIcon1.BalloonHint:='Ваш персонаж погиб.';
      BOT.TrayIcon1.ShowBalloonHint;
    end;
  end;
end;
...
begin
  ...
  h:=OpenProcess(PROCESS_ALL_ACCESS,False,TPID);   {получаем доступ к процессу}
      ...
      ReadProcessMemory(h, Pointer(buf+$3A4), @buf, SIZE_T(4), outbytes);  {читаем память}
      ReadProcessMemory(h, Pointer(buf+$BC), @buf, SIZE_T(4), outbytes);  {читаем память}
      ReadProcessMemory(h, Pointer(buf+$368), @buf, SIZE_T(4), outbytes);  {читаем память}
      ReadProcessMemory(h, Pointer(buf+$34), @buf, SIZE_T(4), outbytes);  {читаем память}
      ReadProcessMemory(h, Pointer(buf+$238), @buf, SIZE_T(4), outbytes);  {читаем память}
      TResult:=buf;
      synchronize(Result);
...
begin
  ...
  h:=OpenProcess(PROCESS_ALL_ACCESS,False,TPID);   {получаем доступ к процессу}
      ...
      ReadProcessMemory(h, Pointer(buf+$3A4), @buf, SIZE_T(4), outbytes);  {читаем память}
      ReadProcessMemory(h, Pointer(buf+$BC), @buf, SIZE_T(4), outbytes);  {читаем память}
      ReadProcessMemory(h, Pointer(buf+$188), @buf, SIZE_T(4), outbytes);  {читаем память}
      ReadProcessMemory(h, Pointer(buf+$C), @buf, SIZE_T(4), outbytes);  {читаем память}
      ReadProcessMemory(h, Pointer(buf+$78), @buf, SIZE_T(4), outbytes);  {читаем память}
      TResult:=buf;
      synchronize(Result);
  closehandle(h);
end;
...
begin
  ...
  h:=OpenProcess(PROCESS_ALL_ACCESS,False,TPID);   {получаем доступ к процессу}
      ...
      ReadProcessMemory(h, Pointer(buf+$3A4), @buf, SIZE_T(4), outbytes);  {читаем память}
      ReadProcessMemory(h, Pointer(buf+$BC), @buf, SIZE_T(4), outbytes);  {читаем память}
      ReadProcessMemory(h, Pointer(buf+$2B4), @buf, SIZE_T(4), outbytes);  {читаем память}
      ReadProcessMemory(h, Pointer(buf+$34), @buf, SIZE_T(4), outbytes);  {читаем память}
      ReadProcessMemory(h, Pointer(buf+$204), @buf, SIZE_T(4), outbytes);  {читаем память}
      TResult:=buf;
      synchronize(Result);
  closehandle(h);
end;
...
var
  i:integer;
  IsCombo, IsAgain{опять напали}:boolean;
begin
  BOT.TrayIcon1.BalloonTitle:='Добивание';
  BOT.TrayIcon1.BalloonHint:='Бот начинает подготавливаться к ребаффу.';
  BOT.TrayIcon1.ShowBalloonHint;
  synchronize(getINF);
  IsCombo:=true;
    ...
    begin
      ...
      if BOT.istarget=false then
        ...
        BOT.LASTMOBDisable;
          ...
          isCombo:=False;
          {оповещаем чтобы не потерять фокус}
          BOT.TrayIcon1.BalloonTitle:='Запуск ребаффа';
          BOT.TrayIcon1.BalloonHint:='Бот начнет ребаффаться через 5 секунд. Пожалуйста, не нажимайте никакие клавиши.';
          BOT.TrayIcon1.ShowBalloonHint;
          {даем время 5 сек чтобы сообразить}
          TLastMob.Sleep(5000);
...
begin
  synchronize(getINF);
  SetWindowPos(TWND, HWND_TOPMOST, 0, 0, 0, 0, SWP_NOACTIVATE or SWP_NOMOVE or SWP_NOSIZE); {поверх всеъ окон}
  ...
  Mouse_Event(MOUSEEVENTF_LEFTDOWN, x, y, 0, 0);
  Mouse_Event(MOUSEEVENTF_LEFTUP, x, y, 0, 0);
  SetWindowPos(TWND, HWND_NOTOPMOST, 0, 0, 0, 0, SWP_NOACTIVATE or SWP_NOMOVE or SWP_NOSIZE); {отключение поверх всех окон}
  ShowWindow(TWND,SW_MINIMIZE);
  BOT.ENABLESKILLS;
  synchronize(result);
  BOT.TrayIcon1.BalloonTitle:='Ребафф закончен';
  BOT.TrayIcon1.BalloonHint:='Бот ребаффнулся, можно делать дела дальше.';
  BOT.TrayIcon1.ShowBalloonHint;
end;
...
{FindLineAge - находим все окна LineAge}
...
{старый поиск в List BOX - отключен}
procedure TBot.FindLineAgeClick(Sender: TObject);
var
  Wnd: HWND;
  buff: array [0..127] of Char;
begin
  LineAgeList.Items.Clear; // Очищаем список процессов в форме
  Wnd := GetWindow(Handle, GW_HWNDFIRST);
  while Wnd <> 0 do
  begin
    // Некоторые окна показывать ненужно
    ...
    begin
      ...
      begin
        LineAgeList.Items.Add(inttostr(GetWindowThreadProcessId(Wnd ,@PID))); // Добавление записи в список
      end;
    end;
...
{Выбор нужного PID пользователем}
...
{таймер добивающий мобов скилами}
...
begin
  ...
  ENABLESKILLS;
  IsBotWork:=True;
  TrayIcon1.BalloonTitle:='Запуск бота';
  TrayIcon1.BalloonHint:='Бот успешно запущен.';
  TrayIcon1.ShowBalloonHint;
  StatusBar1.Panels[0].Text:='Фарм-бот: ВКЛ';
end;
...
begin
  DISABLESKILLS;
  IsBotWork:=False;
  TrayIcon1.BalloonTitle:='Остановка бота';
  TrayIcon1.BalloonHint:='Бот успешно остановлен';
  TrayIcon1.ShowBalloonHint;
  StatusBar1.Panels[0].Text:='Фарм-бот: ВЫКЛ';
end;
...
{Ребафф - добавить координаты}
procedure TBOT.RebuffClickAddClick(Sender: TObject);
begin
  if cursorcoord.Enabled=True then
    begin
      CursorCoord.Enabled:=False;
      RebuffClickAdd.Caption:='Добавить';
    end
    else
    begin
      CursorCoord.Enabled:=True;
      RebuffClickAdd.Caption:='Остановить';
    end;
end;

{Ребафф - добавляем координаты в список при нажатии любой кнопки}
...
{Ребафф - отсчет времени}
procedure TBOT.RebuffTimerTimer(Sender: TObject);
begin
  FarmBotStop.Click;{выключаем все скилы}
...
{выключение\перезагрузка\ждущий режим}
...
begin
  ...
  begin
    ...
    begin
      if IsShutDownOFF.Checked then ExitWindowsEx(EWX_ShutDown,0);// Выключение
      if IsShutDownRESTART.Checked then ExitWindowsEx(EWX_Reboot,0); // Перезагрузка
      if IsShutDownWAIT.Checked then  SetSystemPowerState(true, true);   //Перевести комп в ждущий режим
    end;
  end;
  end;
  end;
